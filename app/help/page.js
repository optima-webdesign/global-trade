...
// 👇 Added FaArrowRight to this list
import { 
        ...
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <div className="relative group">
            ...
            <div className="relative flex items-center bg-[#0a0a0a] border border-white/10 rounded-2xl p-2 shadow-2xl">
              ...
              <input 
                type="text" 
                placeholder="Search for answers (e.g., 'Reset Password', 'API Keys')" 
                className="w-full bg-transparent border-none outline-none text-white px-4 py-3 text-lg placeholder-gray-600"
              />
              <button className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-2.5 rounded-xl font-bold transition-colors">
                Search
              </button>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-24">
            {categories.map((cat, i) => (
              <div key={i} className="glass-panel p-6 rounded-2xl border border-white/5 hover:border-blue-500/30 hover:bg-white/5 transition-all cursor-pointer group">
                <div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400 text-xl mb-4 group-hover:scale-110 transition-transform">
                  {cat.icon}
                </div>
          ...
          <div className="mt-24 p-10 rounded-3xl relative overflow-hidden text-center">
             ...
             <div className="relative z-10">
               ...
               <div className="flex flex-col sm:flex-row justify-center gap-4">
                 <Link href="/dashboard/support" className="px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white font-bold rounded-full transition-colors shadow-lg shadow-blue-600/30">
                   Start Live Chat
                 </Link>
                 <a href="mailto:support@globaltrade.com" className="px-8 py-3 glass-panel hover:bg-white/10 text-white font-bold rounded-full transition-colors border border-white/10">
                   Email Support
                 </a>
               </div>
             </div>
