...
import { FaArrowUp, FaArrowDown, FaChartBar, FaListAlt, FaSignal } from 'react-icons/fa';

// Helper: URL se asset dhundo (e.g. ?asset=ETH) nahi toh default BTC lo
const getAsset = (symbol) => {
  if (!symbol) return MARKET_DATA[0].assets[0]; // Default BTC
...
export default function TradingPage() {
  ...
  // Update asset jab URL change ho
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 pb-20 min-h-screen animate-[slideUp_0.5s_ease-out] relative">
      ...
      {/* RIGHT SIDE: Trade Panel (Sticky on Desktop) */}
